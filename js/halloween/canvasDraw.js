...
(function () {
        ...
        }
        {
                ...
                {
                        /* 写文字 */
                        var gradient = ctx.createLinearGradient(0, 0, 908, 0);
                ...
                {
                        /* 写文字 */
                        var _gradient = ctx.createLinearGradient(0, 0, 301, 0);
                        _gradient.addColorStop("0", "#b61818");
                        _gradient.addColorStop("0.5", "#7a0b0b");
                        _gradient.addColorStop("1.0", "#b61818");
                        ctx2.font = "bold 100px 宋体";
                        ctx2.fillStyle = _gradient;
